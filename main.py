import Olimpo_Scripts_02_ev  as EV
import Olimpo_Scripts_1_Stats as ST
import math 
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            totalEV = new_func(base, level, ev, iv, stats, mod)
            if totalEV <=500:
...
def new_func(base, level, ev, iv, stats, mod):
